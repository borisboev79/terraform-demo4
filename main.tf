...
resource "azurerm_resource_group" "boboev_resource_group" {
...
resource "azurerm_service_plan" "asp" {
  ...
  location            = azurerm_resource_group.boboev_resource_group.location
  resource_group_name = azurerm_resource_group.boboev_resource_group.name
  os_type             = "Linux"
  sku_name            = "F1"

}

resource "azurerm_linux_web_app" "alwa_bb" {
